...
const translations = {
  en: {
    ...
    "aria.showNav": "Show navigation menu",
    "aria.mainAreas": "Main areas",
    "aria.lexicazShots": "View LexicAZ screenshots",
    ...
    "profile.tag": "Educational apps · Unity · C# · Applied AI",
    "profile.apps": "own apps",
    ...
    "mors.caption1": "MorS main screen",
    ...
    "tech.logic": "Application logic",
    "tech.group3": "Web and personal brand",
    "tech.group4": "Technical interests",
    "tech.ux": "UX",
    ...
    "level.lowMedium": "Lower-intermediate",
    "lang.spanish": "Spanish",
    "lang.spanish.desc": "Native spoken and written communication.",
    "lang.english": "English",
    "lang.english.desc": "Professional and technical communication.",
    "lang.italian": "Italian",
    "lang.fluent.desc": "Fluent communication.",
    "lang.dutch": "Dutch",
    "lang.french": "French",
    "lang.general.desc": "General communication.",
    "lang.german": "German",
  ...
  es: {
    ...
    "aria.showNav": "Mostrar menú de navegación",
    "aria.mainAreas": "Áreas principales",
    "aria.lexicazShots": "Ver capturas de LexicAZ",
    ...
    "profile.tag": "Apps educativas · Unity · C# · IA aplicada",
    "profile.apps": "apps propias",
    ...
    "mors.caption1": "Pantalla principal de MorS",
    ...
    "tech.logic": "Lógica de aplicación",
    "tech.group3": "Web y marca personal",
    "tech.group4": "Intereses técnicos",
    "tech.ux": "UX",
    ...
    "level.high": "Alto",
    "level.medium": "Medio",
    "level.lowMedium": "Medio-bajo",
    "lang.spanish": "Español",
    "lang.spanish.desc": "Comunicación oral y escrita nativa.",
    "lang.english": "Inglés",
    "lang.english.desc": "Comunicación profesional y técnica.",
    "lang.italian": "Italiano",
    "lang.fluent.desc": "Comunicación fluida.",
    "lang.dutch": "Neerlandés",
    "lang.french": "Francés",
    "lang.general.desc": "Comunicación general.",
    "lang.german": "Alemán",
...
const projectGalleries = {
  lexicaz: [
    {
      src: "assets/img/lexicaz/inicio-lexicaz.png",
      captions: {
        en: "LexicAZ home screen",
        es: "Pantalla de inicio de LexicAZ"
      }
    },
    {
      src: "assets/img/lexicaz/categoria-idioma.png",
      captions: {
        en: "Language, order and category selection",
        es: "Selección de idiomas, orden y categoría"
      }
    },
    {
      src: "assets/img/lexicaz/juegos.png",
      captions: {
        en: "Game modes menu",
        es: "Menú de modos de juego"
      }
    },
    {
      src: "assets/img/lexicaz/escribe-game.png",
      captions: {
        en: "Write the word mode",
        es: "Modo escribe la palabra"
      }
    },
    {
      src: "assets/img/lexicaz/mentira-game.png",
      captions: {
        en: "Find the lie mode",
        es: "Modo encuentra la mentira"
      }
    },
    {
      src: "assets/img/lexicaz/repasa-game.png",
      captions: {
        en: "Multilingual review mode",
        es: "Modo repaso multilingüe"
      }
    },
    {
      src: "assets/img/lexicaz/verdad-game.png",
      captions: {
        en: "Find the truth mode",
        es: "Modo encuentra la verdad"
      }
    }
  ],
  ...
  mors: [
    {
      src: "assets/img/mors/inicio-mors.png",
      captions: {
        en: "MorS main screen",
        es: "Pantalla principal de MorS"
      }
    },
    {
      src: "assets/img/mors/arbol-morse.png",
      captions: {
        en: "Visual Morse code tree",
        es: "Árbol visual de código Morse"
      }
    },
    {
      src: "assets/img/mors/entrada-pulsacion.png",
      captions: {
        en: "Short and long press input",
        es: "Entrada mediante pulsación corta y larga"
      }
    },
    {
      src: "assets/img/mors/traductor-morse.png",
      captions: {
        en: "Text to Morse code translator",
        es: "Traductor de texto a código Morse"
      }
    },
    {
      src: "assets/img/mors/ajustes-mors.png",
      captions: {
        en: "MorS settings screen",
        es: "Pantalla de ajustes de MorS"
      }
    }
  ]
};
...
function setLanguage(language) {
  ...
  document.querySelectorAll(".flip-card[data-project]").forEach((card) => {
    updateProjectScreenshot(card, false);
  });
...
function getCaption(image) {
  ...
  return image.captions[language] || image.captions.en;
}

function updateProjectScreenshot(card, animate = true) {
  ...
  const currentIndex = projectState[projectName];
  ...
  if (!screenshot || !caption || !counter) {
    return;
  }

  const applyImage = () => {
    const translatedCaption = getCaption(currentImage);
    screenshot.src = currentImage.src;
    screenshot.alt = translatedCaption;
    caption.textContent = translatedCaption;
    counter.textContent = `${currentIndex + 1} / ${gallery.length}`;

    if (animate) {
      screenshot.classList.add("image-slide-animation");
    }
  };

  screenshot.classList.remove("image-slide-animation");

  if (animate) {
    setTimeout(applyImage, 80);
  } else {
    applyImage();
  }
}

function showNextScreenshot(card) {
  const projectName = card.dataset.project;
  const gallery = projectGalleries[projectName];
  const currentIndex = projectState[projectName];
  const isLastScreenshot = currentIndex === gallery.length - 1;

  if (isLastScreenshot) {
    returnToProjectInfo(card);
    projectState[projectName] = 0;
    return;
  }

  projectState[projectName] = currentIndex + 1;
  updateProjectScreenshot(card);
}

function flipProjectCard(card) {
  const projectName = card.dataset.project;
...
function returnToProjectInfo(card) {
  card.classList.remove("is-flipped");
}

function setupFlipCards() {
  const cards = document.querySelectorAll(".flip-card[data-project]");

  cards.forEach((card) => {
    const logoButton = card.querySelector(".project-logo-button");
    const screenshotFrame = card.querySelector(".screenshot-frame");
    const backButton = card.querySelector(".back-to-info");

    if (!logoButton || !screenshotFrame || !backButton) {
      return;
    }

    logoButton.addEventListener("click", () => {
      flipProjectCard(card);
    });

    screenshotFrame.addEventListener("click", () => {
      showNextScreenshot(card);
    });

    screenshotFrame.addEventListener("keydown", (event) => {
    ...
    backButton.addEventListener("click", () => {
      returnToProjectInfo(card);
      projectState[card.dataset.project] = 0;
    });
  });
}
